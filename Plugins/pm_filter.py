...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie/Series Not Found In DataBase 😑\nTheater Print Not Available Here..! 😑\nCheck if the DVD is out ... ??⁇😊')
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.answer('Successfully Back')
        ...
        return await query.answer('Successfully changed')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('♻️ ɢʀᴏᴜᴘ ♻️', url='https://t.me/movies_vers_talks'),

          

            InlineKeyboardButton('🔥ᴅᴇᴠ🔥', url='https://t.me/mr_groot06')],
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⏹️ ʙᴜᴛᴛᴏɴꜱ', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
